        ...
        <ul className="list-group">
            {
                local ? local.map(todo => (
                    <li onClick={() => handleToogle(todo.id)} key={todo.id} className="list-group-item d-flex justify-content-between align-items-start cursor-pointer" style={{ "cursor": "pointer" }}>
